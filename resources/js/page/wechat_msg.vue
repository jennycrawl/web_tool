<template>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
            <a :href="scope.row.content_url"
                target="_blank" class="buttonText">{{scope.row.title}}
            </a>
        </template>
      </el-table-column>
      <el-table-column
  ...
  <script>
    ...
    export default({
      ...
      computed: mapState({
        list: state => state.Wechat.msgList,
        accountList: state => state.Wechat.accountList,
      }),
      created() {
        this.$store.dispatch('Wechat/getMsgList');
      ...
      methods: {
        ...
        onSubmit() {
           ...
           this.$store.dispatch('Wechat/getMsgList', params);
        },
        onClear(refname) {
        ...
        onCurrentPageChange(val) {
            ...
            this.$store.dispatch('Wechat/getMsgList', this.genFormParams());
        },
        onSortChange(column) {
